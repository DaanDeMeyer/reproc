...
Possible Errors:
  ...
  - PROCESS_LIB_PIPE_LIMIT_REACHED: When one or more of the pipes could not be
  allocated

@param process_address Address of a Process pointer. Cannot be NULL. Any already
allocated memory to the Process pointer will be leaked.
