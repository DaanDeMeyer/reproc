...
// CreateProcessW includes multiple NUL-terminators so we can't rely on `strlen`
// to calculate the string length for us. See the lpEnvironment documentation of
