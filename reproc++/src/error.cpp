...
const char *error_category_impl::name() const noexcept { return "reproc"; }
...
bool error_category_impl::equivalent(const std::error_code &error_code,
                                     int error_condition) const noexcept
{
